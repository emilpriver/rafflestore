...
<section id="reportbug">
    ...
    <div class="con">
        <h1>Found an bug? We would love if you told us more about the bug</h1>
        <form action="/reportbug" class="reportbug" method="POST" novalidate>
            <div>
                <span>Your email</span>
                <input type="email" name="email" required>
            </div>
            <div>
                <span>Tell us more about the bug, where did you find the bug, what did you do to create the bug?</span>
                <textarea name="message"></textarea>
            </div>
            <input type="submit" value="Report bug" class="submit">
        </form>
    </div>
</section> </div>